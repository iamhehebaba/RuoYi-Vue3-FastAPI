...
insert into sys_menu values('118',  '模型管理', '1',   '10', 'model',      'system/model/index',      '', '', 1, 0, 'M', '0', '0', 'system:model:list',       'model',         'admin', sysdate(), '', null, '模型管理菜单');
insert into sys_menu values('119',  '知识库管理', '1',  '11', 'kb',        'system/kb/index',          '', '', 1, 0, 'M', '0', '0', 'system:kb:list',         'kb',             'admin', sysdate(), '', null, '知识库管理菜单');
